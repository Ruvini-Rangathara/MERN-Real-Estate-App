                ...
                <div className={'flex flex-col flex-1 gap-4'}>
                    ...
                    <div className={'flex gap-4'}>
                        ...
                        <button
                            ...
                            className={'p-2 text-green-700 border rounded uppercase hover:shadow-lg disabled:opacity-80'}>
                    ...
                    {formData.imageUrls && formData.imageUrls.length > 0 && formData.imageUrls.map((url, index) =>(
                            <div key={url} className={'flex justify-between p-2 border items-center'}>
                                ...
                                <button
                                    ...
                                    className={'p-2 text-red-700 rounded-lg uppercase hover:opacity-75'}>Delete</button>
                            </div>
                        ))
                    }
                    <button
